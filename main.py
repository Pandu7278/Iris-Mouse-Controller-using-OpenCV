...
def smooth(coordinates, alpha=0.5):
    ...
    for (x, y), (prev_x, prev_y) in zip(coordinates,
smooth.previous_coordinates):
...
while True:
    ...
    if landmark_points:
        ...
        for (x, y) in smoothed_coordinates:cv2.circle(frame, (x, y), 3, (0, 255, 0))
        x, y = smoothed_coordinates[1]
# Index 1 is the control point
